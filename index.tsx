...
const ThoughtCard: React.FC<{ 
  ...
  isOwner: boolean;
}> = ({ thought, onDelete, onResonate, onOpen, isOwner }) => {
    ...
    <div className="group relative py-12 border-b border-stone-100 last:border-0 hover:bg-stone-50/50 transition-colors px-6 -mx-6 rounded-[2rem]">
      <div className="flex flex-col gap-6">
        ...
        <div className="flex items-center gap-6">
          ...
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill={thought.resonates > 0 ? "currentColor" : "none"} stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="m12 19-7-7 7-7 7 7-7 7z"/></svg>
            {thought.resonates || 0} Resonates
          </button>
        </div>
      </div>
    </div>
